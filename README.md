# Ansible_Assignment
This repository hosts the code and demo from Ansible Assignment - 202
...
Submit a Word document, with screenshots showing your work, a demo, and all ansible code/scripts via GitHub
